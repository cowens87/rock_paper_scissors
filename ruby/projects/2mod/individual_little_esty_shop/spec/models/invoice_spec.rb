...
RSpec.describe Invoice, type: :model do
  before(:each) do
    ...
    # Invoices:
    @invoice1 = Invoice.create!(status: 0, customer_id: @sally.id, merchant_id: @amazon.id, created_at: 'Sat, 16 Jan 2021 14:42:18 UTC +00:00')
  ...
  it 'Can display the invoice creation date of its 5 most popular items' do
    ...
    expect(expected).to eq(@invoice1.created_at.strftime("%A, %B %d, %Y"))
  end
end
