...
```
- Each intersection has two cross streets, as well as a way to read that data.
- An intersection can list all vehicles that passed through it.
- An intersection can list all vehicles that were speeding through it.
- An intersection can list all drivers that were speeding through it.
```
